            ...
            try:
                ...
                if ocr_text:
                    ...
                    if temperature is not None:
                        # Validate temperature - must be exactly 5°C for testing
                        if temperature != 5.0:
                            ...
                            update.message.reply_text(
                                f"✅ Temperature detected: {temperature}°C (exactly 5°C - valid!)"
                            )
                    else:
